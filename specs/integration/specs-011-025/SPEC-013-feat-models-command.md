# SPEC-013: feat/models-command

## Informações
- **Branch:** feat/models-command
- **Spec:** SPEC-013
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/models-command --no-ff -m "merge: integrate feat/models-command"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/models-command (resolved)"
```
