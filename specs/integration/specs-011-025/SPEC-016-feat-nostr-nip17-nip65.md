# SPEC-016: feat/nostr-nip17-nip65

## Informações
- **Branch:** feat/nostr-nip17-nip65
- **Spec:** SPEC-016
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/nostr-nip17-nip65 --no-ff -m "merge: integrate feat/nostr-nip17-nip65"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/nostr-nip17-nip65 (resolved)"
```
