# SPEC-021: feat/prek-precommit-hooks

## Informações
- **Branch:** feat/prek-precommit-hooks
- **Spec:** SPEC-021
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/prek-precommit-hooks --no-ff -m "merge: integrate feat/prek-precommit-hooks"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/prek-precommit-hooks (resolved)"
```
