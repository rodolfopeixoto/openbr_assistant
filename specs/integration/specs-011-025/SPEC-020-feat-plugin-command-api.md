# SPEC-020: feat/plugin-command-api

## Informações
- **Branch:** feat/plugin-command-api
- **Spec:** SPEC-020
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/plugin-command-api --no-ff -m "merge: integrate feat/plugin-command-api"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/plugin-command-api (resolved)"
```
