# SPEC-018: feat/perplexity-search-provider

## Informações
- **Branch:** feat/perplexity-search-provider
- **Spec:** SPEC-018
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/perplexity-search-provider --no-ff -m "merge: integrate feat/perplexity-search-provider"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/perplexity-search-provider (resolved)"
```
