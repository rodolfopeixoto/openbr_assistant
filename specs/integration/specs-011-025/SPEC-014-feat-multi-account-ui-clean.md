# SPEC-014: feat/multi-account-ui-clean

## Informações
- **Branch:** feat/multi-account-ui-clean
- **Spec:** SPEC-014
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/multi-account-ui-clean --no-ff -m "merge: integrate feat/multi-account-ui-clean"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/multi-account-ui-clean (resolved)"
```
