# SPEC-044: fix/bluebubbles-message-routing

## Informações
- **Branch:** fix/bluebubbles-message-routing
- **Spec:** SPEC-044
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/fix/bluebubbles-message-routing --no-ff -m "merge: integrate fix/bluebubbles-message-routing"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/bluebubbles-message-routing (resolved)"
```
