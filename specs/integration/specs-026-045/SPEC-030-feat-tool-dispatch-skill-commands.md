# SPEC-030: feat/tool-dispatch-skill-commands
...
git merge origin/feat/tool-dispatch-skill-commands --no-ff -m "merge: integrate feat/tool-dispatch-skill-commands"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/tool-dispatch-skill-commands (resolved)"
```
