# SPEC-027: feat/table-to-bullets-telegram

## Informações
- **Branch:** feat/table-to-bullets-telegram
- **Spec:** SPEC-027
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/table-to-bullets-telegram --no-ff -m "merge: integrate feat/table-to-bullets-telegram"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/table-to-bullets-telegram (resolved)"
```
