# SPEC-041: fix/avatar-relative-url-validation

## Informações
- **Branch:** fix/avatar-relative-url-validation
- **Spec:** SPEC-041
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/fix/avatar-relative-url-validation --no-ff -m "merge: integrate fix/avatar-relative-url-validation"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/avatar-relative-url-validation (resolved)"
```
