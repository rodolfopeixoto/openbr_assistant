# SPEC-029: feat/telegram-link-preview-config

## Informações
- **Branch:** feat/telegram-link-preview-config
- **Spec:** SPEC-029
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/telegram-link-preview-config --no-ff -m "merge: integrate feat/telegram-link-preview-config"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/telegram-link-preview-config (resolved)"
```
