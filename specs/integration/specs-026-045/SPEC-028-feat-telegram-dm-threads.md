# SPEC-028: feat/telegram-dm-threads

## Informações
- **Branch:** feat/telegram-dm-threads
- **Spec:** SPEC-028
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/telegram-dm-threads --no-ff -m "merge: integrate feat/telegram-dm-threads"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/telegram-dm-threads (resolved)"
```
