# SPEC-031: feat/tui-syntax-highlighting

## Informações
- **Branch:** feat/tui-syntax-highlighting
- **Spec:** SPEC-031
- **Status:** ⏳ Pendente
- **Prioridade:** 🟡 Média
...
git merge origin/feat/tui-syntax-highlighting --no-ff -m "merge: integrate feat/tui-syntax-highlighting"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/tui-syntax-highlighting (resolved)"
```
