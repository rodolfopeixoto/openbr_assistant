# SPEC-062: fix/export-section-meta

## Informações
- **Branch:** fix/export-section-meta
- **Spec:** SPEC-062
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/export-section-meta --no-ff -m "merge: integrate fix/export-section-meta"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/export-section-meta (resolved)"
```
