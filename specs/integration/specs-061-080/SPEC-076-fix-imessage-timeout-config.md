# SPEC-076: fix/imessage-timeout-config

## Informações
- **Branch:** fix/imessage-timeout-config
- **Spec:** SPEC-076
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/imessage-timeout-config --no-ff -m "merge: integrate fix/imessage-timeout-config"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/imessage-timeout-config (resolved)"
```
