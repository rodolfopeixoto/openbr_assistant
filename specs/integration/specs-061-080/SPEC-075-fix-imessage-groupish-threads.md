# SPEC-075: fix/imessage-groupish-threads

## Informações
- **Branch:** fix/imessage-groupish-threads
- **Spec:** SPEC-075
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/imessage-groupish-threads --no-ff -m "merge: integrate fix/imessage-groupish-threads"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/imessage-groupish-threads (resolved)"
```
