# SPEC-078: fix/imsg-remote-attachments

## Informações
- **Branch:** fix/imsg-remote-attachments
- **Spec:** SPEC-078
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/imsg-remote-attachments --no-ff -m "merge: integrate fix/imsg-remote-attachments"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/imsg-remote-attachments (resolved)"
```
