# SPEC-067: fix/gateway-token-resolution-mode-check

## Informações
- **Branch:** fix/gateway-token-resolution-mode-check
- **Spec:** SPEC-067
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/gateway-token-resolution-mode-check --no-ff -m "merge: integrate fix/gateway-token-resolution-mode-check"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/gateway-token-resolution-mode-check (resolved)"
```
