# SPEC-064: fix/fallback-authprofile-provider-scope

## Informações
- **Branch:** fix/fallback-authprofile-provider-scope
- **Spec:** SPEC-064
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/fallback-authprofile-provider-scope --no-ff -m "merge: integrate fix/fallback-authprofile-provider-scope"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/fallback-authprofile-provider-scope (resolved)"
```
