# SPEC-058: fix/dockerfile-install-bun

## Informações
- **Branch:** fix/dockerfile-install-bun
- **Spec:** SPEC-058
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/dockerfile-install-bun --no-ff -m "merge: integrate fix/dockerfile-install-bun"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/dockerfile-install-bun (resolved)"
```
