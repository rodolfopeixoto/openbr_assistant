# SPEC-046: fix/capabilities-object-format

## Informações
- **Branch:** fix/capabilities-object-format
- **Spec:** SPEC-046
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/capabilities-object-format --no-ff -m "merge: integrate fix/capabilities-object-format"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/capabilities-object-format (resolved)"
```
