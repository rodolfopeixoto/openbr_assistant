# SPEC-049: fix/cli-quick-reference-system-prompt

## Informações
- **Branch:** fix/cli-quick-reference-system-prompt
- **Spec:** SPEC-049
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/cli-quick-reference-system-prompt --no-ff -m "merge: integrate fix/cli-quick-reference-system-prompt"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/cli-quick-reference-system-prompt (resolved)"
```
