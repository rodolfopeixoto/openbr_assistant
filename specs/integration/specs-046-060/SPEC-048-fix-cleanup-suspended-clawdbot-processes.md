# SPEC-048: fix/cleanup-suspended-clawdbot-processes

## Informações
- **Branch:** fix/cleanup-suspended-clawdbot-processes
- **Spec:** SPEC-048
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/cleanup-suspended-clawdbot-processes --no-ff -m "merge: integrate fix/cleanup-suspended-clawdbot-processes"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/cleanup-suspended-clawdbot-processes (resolved)"
```
