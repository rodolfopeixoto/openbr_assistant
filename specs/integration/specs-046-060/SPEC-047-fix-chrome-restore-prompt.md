# SPEC-047: fix/chrome-restore-prompt

## Informações
- **Branch:** fix/chrome-restore-prompt
- **Spec:** SPEC-047
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/chrome-restore-prompt --no-ff -m "merge: integrate fix/chrome-restore-prompt"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/chrome-restore-prompt (resolved)"
```
