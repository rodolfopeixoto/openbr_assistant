# SPEC-051: fix/codesign-ad-hoc-fallback

## Informações
- **Branch:** fix/codesign-ad-hoc-fallback
- **Spec:** SPEC-051
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/codesign-ad-hoc-fallback --no-ff -m "merge: integrate fix/codesign-ad-hoc-fallback"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/codesign-ad-hoc-fallback (resolved)"
```
