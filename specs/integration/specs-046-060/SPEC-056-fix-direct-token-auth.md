# SPEC-056: fix/direct-token-auth

## Informações
- **Branch:** fix/direct-token-auth
- **Spec:** SPEC-056
- **Status:** ⏳ Pendente
- **Prioridade:** ⚪ Baixa
...
git merge origin/fix/direct-token-auth --no-ff -m "merge: integrate fix/direct-token-auth"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate fix/direct-token-auth (resolved)"
```
