# SPEC-006: feat/custom-tts-endpoint

## Informações
- **Branch:** feat/custom-tts-endpoint
- **Spec:** SPEC-006
- **Status:** ⏳ Pendente
- **Prioridade:** 🔴 Alta
...
git merge origin/feat/custom-tts-endpoint --no-ff -m "merge: integrate feat/custom-tts-endpoint"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/custom-tts-endpoint (resolved)"
```
