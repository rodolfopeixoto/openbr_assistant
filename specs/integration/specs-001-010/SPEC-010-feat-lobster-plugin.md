# SPEC-010: feat/lobster-plugin

## Informações
- **Branch:** feat/lobster-plugin
- **Spec:** SPEC-010
- **Status:** ⏳ Pendente
- **Prioridade:** 🔴 Alta
...
git merge origin/feat/lobster-plugin --no-ff -m "merge: integrate feat/lobster-plugin"
# Resolver conflitos se necessário
pnpm build
git commit -m "merge: integrate feat/lobster-plugin (resolved)"
```
