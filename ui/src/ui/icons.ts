...
export const icons = {
  ...
  eyeOff: html`
    <svg viewBox="0 0 24 24">
      ...
      <path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7c1.22 0 2.38-.22 3.47-.6" />
      <path d="M2 2l20 20" />
    </svg>
  `,
  helpCircle: html`
  ...
  key: html`
    <svg viewBox="0 0 24 24">
      <path d="m21 2-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0 3 3L22 7l-3-3-1.5 1.5" />
    </svg>
  `,
  scan: html`
    <svg viewBox="0 0 24 24">
  ...
  fingerprint: html`
    <svg viewBox="0 0 24 24">
      ...
      <path d="M12 10a2 2 0 0 1 2 2c0 2.3-.2 3.7-.5 5" />
      <path d="M8.65 22c.3-1.2.8-3.5.9-5.5" />
      <path d="M14 13.12c0 2.38 0 6.38-1 8.88" />
      <path d="M2 16h.01" />
      <path d="M21.8 16c.2-2 .131-5.354 0-6" />
      <path d="M9 6.8a6 6 0 0 1 9 5.2c0 .49 0 1.5-.03 2" />
      <path d="M9.8 22c.2-1.2.4-2.8.4-4" />
    </svg>
  `,
  verified: html`
    <svg viewBox="0 0 24 24">
  ...
  alertOctagon: html`
    <svg viewBox="0 0 24 24">
      <path d="M12 16h.01" />
      <path d="M12 8v4" />
      <path d="M15.312 2a2 2 0 0 1 1.414.586l4.688 4.688A2 2 0 0 1 22 8.688v6.624a2 2 0 0 1-.586 1.414l-4.688 4.688a2 2 0 0 1-1.414.586H8.688a2 2 0 0 1-1.414-.586l-4.688-4.688A2 2 0 0 1 2 15.312V8.688a2 2 0 0 1 .586-1.414l4.688-4.688A2 2 0 0 1 8.688 2h6.624z" />
    </svg>
  `,
  ...
  `,
  // Additional icons for Features page
  slack: html`
    <svg viewBox="0 0 24 24">
