...
// OAuth constants - must be configured via environment variables
// These values should be set in your environment, not committed to the repository
...
if (!CLIENT_ID || !CLIENT_SECRET) {
  throw new Error(
    "ANTIGRAVITY_CLIENT_ID and ANTIGRAVITY_CLIENT_SECRET environment variables must be set",
  );
}
